...
const imageResize_1 = require("../router/imageResize");
...
describe("test imageconvert", () => {
    it("image function", () => __awaiter(void 0, void 0, void 0, function* () {
        const resize = path_1.default.resolve(__dirname, "../../image/new/encenadaport_new.jpg");
        const img = path_1.default.resolve(__dirname, `../../image/old/encenadaport.jpg`);
        expect(() => __awaiter(void 0, void 0, void 0, function* () {
            yield (0, imageResize_1.imageconvert)(img, 50, 50, resize);
        })).not.toThrow();
    }));
});
