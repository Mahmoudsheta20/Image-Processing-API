...
const imageResize_2 = require("./imageResize");
    ...
    try {
        ...
        if (width <= 0 || height <= 0) {
            ...
            if (isNaN(width) && isNaN(height)) {
                ...
                if (imageResize_2.cache.get("imageName") === newImage &&
                    imageResize_2.cache.get("width") === width &&
                    imageResize_2.cache.get("height") === height) {
                    const x = imageResize_2.cache.get("imageName");
                    res.sendFile(x);
                }
                else {
